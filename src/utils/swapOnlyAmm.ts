...
export async function getBuyTx(solanaConnection: Connection, wallet: WalletContextState, baseMint: PublicKey, quoteMint: PublicKey, amount: number, targetPool: string) {
...
export async function getSellTx(solanaConnection: Connection, wallet: WalletContextState, baseMint: PublicKey, quoteMint: PublicKey, amount: string, targetPool: string) {
    try {
